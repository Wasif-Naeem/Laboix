    ...
    <nav class="pc-sidebar">
        <div class="navbar-wrapper">
            <div class="m-header"><a href="index.html"
                    class="b-brand text-primary"><!-- ========   Change your logo from here   ============ --> <img src="assets/images/logo-light.png" alt="Laboix HTML" width="170px"></a></div>
                ...
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item pc-hasmenu"><a style="cursor: pointer;" class="pc-link"><span class="pc-micon"><i
                        ...
                        <ul class="pc-submenu">
                            ...
                            <li class="pc-item"><a class="pc-link" href="/allvaccines">All Vaccines Data</a></li>
                            <li class="pc-item"><a class="pc-link" href="/allhospitals">All Hospitals Data</a></li>
                            <li class="pc-item"><a class="pc-link" href="/allrequest">All Appoinment Req</a></li>
                            <li class="pc-item"><a class="pc-link" href="/allreportsadmin">All Appoinment Reports</a></li>
                        </ul>
                    </li>
            ...
            <div class="ms-auto">
                <ul class="list-unstyled">
                    ...
                    <li class="dropdown pc-h-item header-user-profile"><a
                            ...
                            aria-expanded="false"><img src="../assets/images/user/avatar-2.jpg" alt="user-image"
                                class="user-avtar"></a>
            ...
            <div class="row">
                ...
                <div class="col-auto my-1">
                    <ul class="list-inline footer-link mb-0">
                        <li class="list-inline-item"><a href="../index.html">Home</a></li><!-- todo link update -->
