            ...
            <div class="row">
                ...
                <div class="col-md-12 col-xl-4">
                    <div class="card balance-card card-border-warning">
                        ...
                        <div class="card-body">
                            ...
                            <a class="btn btn-warning m-t-15 m-b-20 text-white" href='/appoinment/{{Auth::user()->id}}'>Check Requests</a>
                ...
                <div class="col-md-12 col-xl-12">
                    <div class="card balance-card card-border-primary">
                        ...
                        <div class="card-body">
                            <h2>2</h2>
                            <p class="text-muted f-15">Available Vaccine At {{Auth::user()->name}}</p>
                            <a class="btn btn-warning m-t-15 m-b-20 text-white" href="/seevaccines/{{Auth::user()->id}}">See List</a>
