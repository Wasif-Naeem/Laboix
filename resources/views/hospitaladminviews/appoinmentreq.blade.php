                                        ...
                                        <tbody>
                                           ...
                                           @foreach ($appoinments as $appoinment)
                                            ...
                                            <tr>
                                                ...
                                                <td >
                                                    @if ($appoinment->hospital_approval == 'Not Approved')
                                                        
                                                    <a  href=""><i class="feather  icon-trash-2 f-16 text-danger"></i></a><a href="/hosapproved/{{$appoinment->id}}" class="ms-3"><i class="icon feather icon-check f-16 text-success"></i></a>
                                                    @else 
                                                    <a href="/report/{{$appoinment->id}}" class="btn btn-success">Update Report</a>
