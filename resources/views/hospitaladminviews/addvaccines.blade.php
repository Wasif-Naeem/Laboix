          ...
          <div class="row align-items-center justify-content-between">
            ...
            <div class="col-sm-auto">
              <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item" aria-current="page">Add Vaccine</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-12">
          <div class="card">
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-md-12">
                  <form action="/addvacinnation" method="POST" id="vaccinefrom">
                    @if (Session('success'))
            ...
            @endif
                    ...
                    <div class="mb-3"><label class="form-label" for="exampleInputEmail1">Vaccine Name</label> <input
                        ...
                        placeholder="Enter Vaccine Name" required></div>
                    ...
                    <button type="submit"
                      class="btn btn-primary mb-4">Add New</button> <a href="/seevaccines/{{Auth::user()->id}}" class="btn btn-warning mb-4">View Vaccines</a>
                  </form>
                </div>
